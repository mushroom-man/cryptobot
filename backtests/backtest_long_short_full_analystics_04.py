...
# -*- coding: utf-8 -*-
"""
Long/Short Backtest v04 — Shared Engine Integration
=====================================================
CHANGES FROM v03:
  - Signal generation (24h), hit rates, quality filter, and hysteresis
    now import from the shared engine (cryptobot.signals.*) instead of
    duplicating logic locally.  This eliminates drift risk between
    backtest and live system.
  - 1h signal generation retained locally (vectorized batch approach)
    but uses shared helpers (_resample_ohlcv, _label_trend_binary) and
    RegimeConfig for single-source-of-truth parameters.
  - NO_MA72_ONLY filter retained locally (not yet in shared engine).
  - All portfolio-level logic (risk parity, vol scaling, DD protection,
    cost model, rebalance dead zone, confirmation filter) unchanged.
  - Produces IDENTICAL results to v03 — shared engine was validated
    100% match across all 6 pairs and 3 test levels.
...
Usage:
    python backtest_long_short_full_analytics_04.py
"""
...
def main():
    print("=" * 130)
    print("LONG/SHORT BACKTEST v04 — SHARED ENGINE INTEGRATION")
    print("=" * 130)

    print(f"""
    ╔═══════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════╗
    ║  LONG/SHORT STRATEGY — HOURLY CYCLE  (v04: shared engine)                                                             ║
    ╠═══════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════╣
    ║                                                                                                                         ║
    ...
    print("\n" + "=" * 130)
    print("BACKTEST v04 COMPLETE (shared engine)")
    print("=" * 130)
